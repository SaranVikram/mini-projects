...
function App() {
  ...
  const getPerson = async () => {
    ...
    const newPerson = { phone, email, image, password, name: `${first} ${last}`, age, street: `${number} ${name}` }
    setPerson(newPerson)
    setLoading(false)
    setTitle("name")
    ...
    <main>
      ...
      <div className="block">
        <div className="container">
          <img src={loading ? defaultImage : person.image} alt="random user" className="user-img" />
